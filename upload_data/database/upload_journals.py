...
relation_df1 = pd.read_csv("./../../data_text/journal/set1/Relation_Pack1.csv")
relation_df2 = pd.read_csv("./../../data_text/journal/set2/relation.csv")

# relation_df1 = pd.read_csv("./data_text/journal/set1/Relation_Pack1.csv")
# relation_df2 = pd.read_csv("./data_text/journal/set2/relation.csv")

PROFILE_DIRECTORY1 = "./../../data_text/journal/set1/json-pack_1/"
TXT_DIRECTORY1 = "./../../data_text/journal/set1/txt-pack_1/"

# PROFILE_DIRECTORY1 = "./data_text/journal/set1/json-pack_1/"
# TXT_DIRECTORY1 = "./data_text/journal/set1/txt-pack_1/"

PROFILE_DIRECTORY2 = "./../../data_text/journal/set2/json-pack_2_Profile/N1000/"
TXT_DIRECTORY2 = "./../../data_text/journal/set2/txt_pack_2/txt/"
