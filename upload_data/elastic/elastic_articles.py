...
es = Elasticsearch(
    f"http://{config("ELK_USER")}:{config("ELK_PASSWORD")}@193.151.149.247:9200", timeout=30, max_retries=10, retry_on_timeout=True)
if es.ping():
    print("Connected!")
else:
...
# null values
# https://stackoverflow.com/questions/60538475/how-to-handle-nulls-in-an-elasticsearch-index
